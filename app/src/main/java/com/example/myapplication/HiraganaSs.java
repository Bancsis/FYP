...
public class HiraganaSs extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hiragana_ss);
    ...
    public void onClickCheck(View view) {
        ...
        if (ctrl.correctOrder.get(0) != 1) { ctrl.src1.setImageResource(R.drawable.hiragana_sa_red); }
        if (ctrl.correctOrder.get(0) == 1) { ctrl.src1.setImageResource(R.drawable.hiragana_sa_green); }
        if (ctrl.correctOrder.get(1) != 2) { ctrl.src2.setImageResource(R.drawable.hiragana_shi_red); }
        if (ctrl.correctOrder.get(1) == 2) { ctrl.src2.setImageResource(R.drawable.hiragana_shi_green); }
        if (ctrl.correctOrder.get(2) != 3) { ctrl.src3.setImageResource(R.drawable.hiragana_su_red); }
        if (ctrl.correctOrder.get(2) == 3) { ctrl.src3.setImageResource(R.drawable.hiragana_su_green); }
        if (ctrl.correctOrder.get(3) != 4) { ctrl.src4.setImageResource(R.drawable.hiragana_se_red); }
        if (ctrl.correctOrder.get(3) == 4) { ctrl.src4.setImageResource(R.drawable.hiragana_se_green); }
        if (ctrl.correctOrder.get(4) != 5) { ctrl.src5.setImageResource(R.drawable.hiragana_so_red); }
        if (ctrl.correctOrder.get(4) == 5) { ctrl.src5.setImageResource(R.drawable.hiragana_so_green); }
    }
    ...
    public void onClickBackArrow(View view) {
        Intent myIntent = new Intent(HiraganaSs.this, HiraganaHome.class);
        HiraganaSs.this.startActivity(myIntent);
    }
    ...
    public void japCharConnection(){
        ctrl.char1 = new ImageMap(1, R.drawable.hiragana_sa);
        ctrl.char2 = new ImageMap(2, R.drawable.hiragana_shi);
        ctrl.char3 = new ImageMap(3, R.drawable.hiragana_su);
        ctrl.char4 = new ImageMap(4, R.drawable.hiragana_se);
        ctrl.char5 = new ImageMap(5, R.drawable.hiragana_so);
    }
