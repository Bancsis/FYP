...
public class HiraganaTs extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hiragana_ts);
    ...
    public void onClickCheck(View view) {
        ...
        if (ctrl.correctOrder.get(0) != 1) { ctrl.src1.setImageResource(R.drawable.hiragana_ta_red); }
        if (ctrl.correctOrder.get(0) == 1) { ctrl.src1.setImageResource(R.drawable.hiragana_ta_green); }
        if (ctrl.correctOrder.get(1) != 2) { ctrl.src2.setImageResource(R.drawable.hiragana_chi_red); }
        if (ctrl.correctOrder.get(1) == 2) { ctrl.src2.setImageResource(R.drawable.hiragana_chi_green); }
        if (ctrl.correctOrder.get(2) != 3) { ctrl.src3.setImageResource(R.drawable.hiragana_tsu_red); }
        if (ctrl.correctOrder.get(2) == 3) { ctrl.src3.setImageResource(R.drawable.hiragana_tsu_green); }
        if (ctrl.correctOrder.get(3) != 4) { ctrl.src4.setImageResource(R.drawable.hiragana_te_red); }
        if (ctrl.correctOrder.get(3) == 4) { ctrl.src4.setImageResource(R.drawable.hiragana_te_green); }
        if (ctrl.correctOrder.get(4) != 5) { ctrl.src5.setImageResource(R.drawable.hiragana_to_red); }
        if (ctrl.correctOrder.get(4) == 5) { ctrl.src5.setImageResource(R.drawable.hiragana_to_green); }
    }
    ...
    public void onClickBackArrow(View view) {
        Intent myIntent = new Intent(HiraganaTs.this, HiraganaHome.class);
        HiraganaTs.this.startActivity(myIntent);
    }
    ...
    public void japCharConnection(){
        ctrl.char1 = new ImageMap(1, R.drawable.hiragana_ta);
        ctrl.char2 = new ImageMap(2, R.drawable.hiragana_chi);
        ctrl.char3 = new ImageMap(3, R.drawable.hiragana_tsu);
        ctrl.char4 = new ImageMap(4, R.drawable.hiragana_te);
        ctrl.char5 = new ImageMap(5, R.drawable.hiragana_to);
    }
