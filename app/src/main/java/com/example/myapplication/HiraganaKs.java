...
public class HiraganaKs extends AppCompatActivity {
    ...
    HiraganaVowels ma = new HiraganaVowels();
...
//        ctrl.hiragana_text.setImageResource(R.drawable.hiragana_ks);
    }
    ...
    public void onClickCheck(View view) {
        ...
        if (ctrl.correctOrder.get(0) != 1) { ctrl.src1.setImageResource(R.drawable.hiragana_ka_red); }
        if (ctrl.correctOrder.get(0) == 1) { ctrl.src1.setImageResource(R.drawable.hiragana_ka_green); }
        if (ctrl.correctOrder.get(1) != 2) { ctrl.src2.setImageResource(R.drawable.hiragana_ki_red); }
        if (ctrl.correctOrder.get(1) == 2) { ctrl.src2.setImageResource(R.drawable.hiragana_ki_green); }
        if (ctrl.correctOrder.get(2) != 3) { ctrl.src3.setImageResource(R.drawable.hiragana_ku_red); }
        if (ctrl.correctOrder.get(2) == 3) { ctrl.src3.setImageResource(R.drawable.hiragana_ku_green); }
        if (ctrl.correctOrder.get(3) != 4) { ctrl.src4.setImageResource(R.drawable.hiragana_ke_red); }
        if (ctrl.correctOrder.get(3) == 4) { ctrl.src4.setImageResource(R.drawable.hiragana_ke_green); }
        if (ctrl.correctOrder.get(4) != 5) { ctrl.src5.setImageResource(R.drawable.hiragana_ko_red); }
        if (ctrl.correctOrder.get(4) == 5) { ctrl.src5.setImageResource(R.drawable.hiragana_ko_green); }
    }
    ...
    public void onClickBackArrow(View view) {
        Intent myIntent = new Intent(HiraganaKs.this, HiraganaHome.class);
