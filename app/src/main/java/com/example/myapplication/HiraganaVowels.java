...
public class HiraganaVowels extends AppCompatActivity {
    ...
    public void onClickCheck(View view) {
        ...
        System.out.println(ctrl.correctOrder);
        if (ctrl.correctOrder.get(0) != 1) { ctrl.src1.setImageResource(R.drawable.hiragana_a_red); }
        if (ctrl.correctOrder.get(0) == 1) { ctrl.src1.setImageResource(R.drawable.hiragana_a_green); }
        if (ctrl.correctOrder.get(1) != 2) { ctrl.src2.setImageResource(R.drawable.hiragana_i_red); }
        if (ctrl.correctOrder.get(1) == 2) { ctrl.src2.setImageResource(R.drawable.hiragana_i_green); }
        if (ctrl.correctOrder.get(2) != 3) { ctrl.src3.setImageResource(R.drawable.hiragana_u_red); }
        if (ctrl.correctOrder.get(2) == 3) { ctrl.src3.setImageResource(R.drawable.hiragana_u_green); }
        if (ctrl.correctOrder.get(3) != 4) { ctrl.src4.setImageResource(R.drawable.hiragana_e_red); }
        if (ctrl.correctOrder.get(3) == 4) { ctrl.src4.setImageResource(R.drawable.hiragana_e_green); }
        if (ctrl.correctOrder.get(4) != 5) { ctrl.src5.setImageResource(R.drawable.hiragana_o_red); }
        if (ctrl.correctOrder.get(4) == 5) { ctrl.src5.setImageResource(R.drawable.hiragana_o_green); }
    }
    ...
    public void onClickBackArrow(View view) {
        Intent myIntent = new Intent(HiraganaVowels.this, HiraganaHome.class);
        HiraganaVowels.this.startActivity(myIntent);
    }
    ...
    public void japCharConnection(){
        ctrl.char1 = new ImageMap(1, R.drawable.hiragana_a);
        ctrl.char2 = new ImageMap(2, R.drawable.hiragana_i);
        ctrl.char3 = new ImageMap(3, R.drawable.hiragana_u);
        ctrl.char4 = new ImageMap(4, R.drawable.hiragana_e);
        ctrl.char5 = new ImageMap(5, R.drawable.hiragana_o);
    }
